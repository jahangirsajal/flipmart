...
<div class="content-header">
    ...
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><a href="javascript:avoid(0)">Edit Sub Category</a></li>
        </ul>
    </div>
</div>
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="{{ route('update-subcategory') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="category" name="category_id">
                                            ...
                                            <option value="{{ $row->id}}" {{ $row->id == $subcategory->category_id ? 'selected':'' }} >{{ ucwords($row->category_name)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="subcategory_name" id="subcategory"  value="{{ $subcategory->subcategory_name }}"  >
